...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{stopwords\_id}\SpecialCharTok{$}\NormalTok{kata }\OtherTok{\textless{}{-}} \FunctionTok{paste0}\NormalTok{(}\StringTok{"}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{b"}\NormalTok{, stopwords\_id}\SpecialCharTok{$}\NormalTok{kata, }\StringTok{"}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{b"}\NormalTok{)  }\CommentTok{\# excact macth}
