...
::: {.columns}
::: {.column width="50%"}
![Library dianalogikan sebagai perpustakaan](images/introtods12.jpeg)
:::

::: {.column width="50%"}

![Package dianalogikan sebagai buku](images/introtods13.png)
:::
:::
...
Operator persen lebih dari persen disebut pipe dan bisa dibaca `kemudian`. Contohnya adalah sebagai berikut. 
...
Skrip diatas berarti kita menggunakan data, `kemudian` kita hanya memilih `kolom 1 sampai 4` saja, dari daftar siswa tersebut `kemudian` kita hanya memilih yang nilai di `kolom_1` nya `lebih dari atau sama dengan 10`.
