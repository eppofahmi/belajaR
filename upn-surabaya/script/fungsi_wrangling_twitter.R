...
tweet_wrangler <- function(data, # data frame
                           kolom_teks, # kolom teks
                           kolom_pengirim) # kolom pengirim twit
{
  # lib
  library(tidyverse)
  library(qdap)
  ...
  # hashtag
  hashtag <- as.character(data[ ,kolom_teks])
...
# tweet_user <- tweet_wrangler(data = kementerian, kolom_teks = 4, kolom_pengirim = 3)
