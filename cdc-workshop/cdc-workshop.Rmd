...
# Collecting tweets
raw_jkw <- searchTwitter("@jokowi", n=5000, lang="id", resultType = "recent")
...
# Collecting tweets
raw_prb <- searchTwitter("@prabowo", n=5000, lang="id", resultType = "recent")
# Transform tweets list into a data frame
...
# run the funtion 
tagar_jkw <- tag_detect(raw_jkw)
tagar_prb <- tag_detect(raw_prb)
